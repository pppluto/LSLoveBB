        ...
        if (scrollView.showsPullToRefresh) {
          if (self.isObserving) {
            ...
            [scrollView removeObserver:self forKeyPath:@"frame"];
              [self.activityIndicatorView stopTimer];
            self.isObserving = NO;
          }
        }
    }
...
- (MyActivityIndicatorView *)activityIndicatorView {
    if(!_activityIndicatorView) {
        _activityIndicatorView = [[MyActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhite];
